...
using Training.RabbitMQ.Api.Data;
...
using Training.RabbitMQ.Infrastructure.Common.Caching.Brokers;
using Training.RabbitMQ.Infrastructure.Common.EventBus.Brokers;
using Training.RabbitMQ.Infrastructure.Common.EventBus.Services;
using Training.RabbitMQ.Infrastructure.Common.Identity.Services;
using Training.RabbitMQ.Infrastructure.Common.Notifications.Brokers;
using Training.RabbitMQ.Infrastructure.Common.Notifications.EventSubscriber;
using Training.RabbitMQ.Infrastructure.Common.Notifications.Services;
using Training.RabbitMQ.Infrastructure.Common.Serializers;
using Training.RabbitMQ.Infrastructure.Common.Settings;
using Training.RabbitMQ.Infrastructure.Common.Verifications.Services;
using Training.RabbitMQ.Persistence.Caching.Brokers;
using Training.RabbitMQ.Persistence.DataContexts;
using Training.RabbitMQ.Persistence.Repositories;
using Training.RabbitMQ.Persistence.Repositories.Interfaces;

namespace Training.RabbitMQ.Api.Configurations;

...
namespace Training.RabbitMQ.Infrastructure.Common.Verifications.Services;
    ...
    : IVerificationProcessingService
{
    ...
    private async ValueTask<bool> VerifyUserInfoAsync(string code, CancellationToken cancellationToken = default)
    {
        ...
        await userInfoVerificationCodeService.DeactivateAsync(userInfoVerificationCode.Code.Id, true, cancellationToken);
